...
namespace WebApplication.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,FirstName,LastName,DateOfBirth,Salary,Bonus,StartTime,Email,URL,DocumentTypeId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,FirstName,LastName,DateOfBirth,Salary,Bonus,StartTime,Email,URL,DocumentTypeId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
